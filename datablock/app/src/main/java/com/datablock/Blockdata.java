...
public final class Blockdata extends JavaPlugin {
    ...
    public void onEnable() {
        getLogger().info(ANSI_YELLOW+"BlockData Plugin habilitado!"+ANSI_RESET);
        getLogger().info(ANSI_YELLOW+"  __        __    __         __   __  ___ ___"+ANSI_RESET);
        getLogger().info(ANSI_YELLOW+" |__)  |   |  |  |    |_/   |  ) |__|  |  |__| "+ANSI_RESET+"BlockData v2.3");
        getLogger().info(ANSI_YELLOW+" |__)  |__ |__|  |__  |     |__) |  |  |  |  | "+ANSI_RESET+"Spigot on Bukkit - CraftBukkit");
        ...
        loadLockedChests();
         // Certifique-se de que este método é chamado após as etapas acima
        ...
        this.getCommand("loadchests").setExecutor(new LockChestCommand(chestLockListener));
    ...
    public void onDisable() {
        getLogger().info("blockdata desabilitado!");
        if (connection != null) {
            try {
                connection.close();
    ...
    private void setupDatabaseConnection() {
        ...
        try {
            ...
            getLogger().info(ANSI_YELLOW+"Conexao com o banco de dados estabelecida."+ANSI_RESET);
        } catch (Exception e) {
    ...
    private void setupDatabase() {
        ...
        try (Statement stmt = connection.createStatement()) {
            ...
            getLogger().info(ANSI_YELLOW+"Tabela 'locked_chests' configurada com sucesso!");
        } catch (Exception e) {
